    ...
    <div class="sidebar-wrapper active">
                ...
                <div class="logo">
                    <g>
                        <img src="./assets/compiled/svg/favicon.svg" alt="Logo" srcset="">
                            <span style="font-size: 20px;"> PT ASD</span>
                    </g>
                </div>
        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <li class="sidebar-item {{ Request::segment(1) == 'penjualan' ? 'active' : '' }}">
                ...
                <div class="divider">
                    ...
                    <li class="sidebar-item {{ Request::segment(1) == 'pengguna' ? 'active' : '' }}">
                    ...
                    <li class="sidebar-item {{ Request::segment(1) == 'peramalan' ? 'active' : '' }}">
                        <a href="{{ route('peramalan.index') }}" class='sidebar-link'>
                    ...
                    <li class="sidebar-item has-sub">
                        ...
                        <ul class="submenu {{ Request::segment(1) == 'profil' ? 'submenu-open' : '' }}">
